...
public:
	...
	UPROPERTY()     // macro que indica que la variable SceneComponent es una variable que se puede editar en el editor de Unreal Engine.
		APieza* CurrentPiece;		// variable que almacena la pieza actual.
...
private:
	...
	UPROPERTY(VisibleAnywhere, Category = "Main")
		class ABloqueBrillante* BloqueBrillante;

	UPROPERTY(VisibleAnywhere, Category = "Main")
		class ABloqueDorado* BloqueDorado;

	UPROPERTY(VisibleAnywhere, Category = "Main")
		class ABloqueMetalico* BloqueMetalico;

	UPROPERTY(VisibleAnywhere, Category = "Main")
		class ABloqueHielo* BloqueHielo;

	UPROPERTY(VisibleAnywhere, Category = "Main")
		class ABloquePiedra* BloquePiedra;

	UPROPERTY(VisibleAnywhere, Category = "Main")
		class ABloqueMulticolor* BloqueMulticolor;

	//The Engineer Actor
	UPROPERTY(VisibleAnywhere, Category = "Main")
		class APiezaDirector* PiezaDirector;
};
