...
APiece::APiece()
{
    ...
    struct FConstructorStatics
    {
        ...
        FConstructorStatics()                                                   // "F" indica que es una estructura de datos de la biblioteca básica de Unreal Engine.
            : Color_0(TEXT("Material'/Game/StarterContent/Materials/M_CobbleStone_Rough.M_CobbleStone_Rough'"))       // Cargar los materiales del unreal
...
void APiece::SpawnBlocks()
{
    ...
    {
        {{-40.0, 0.0}, {-20.0, 0.0}, {0.0, 0.0}, {20.0, 0.0}},                                               // Pieza Linea
