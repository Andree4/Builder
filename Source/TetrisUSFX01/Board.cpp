...
void ABoard::NewPiece()  // Crear una nueva pieza
{
    ...
    {
    case 0:
        BloqueBrillante = GetWorld()->SpawnActor<ABloqueBrillante>(ABloqueBrillante::StaticClass());
        PiezaDirector->SetConstruirPieza(BloqueBrillante);
        GEngine->AddOnScreenDebugMessage(-1, 4, FColor::Yellow, TEXT("Pieza Brillante"));
        break;
    case 1:
        BloqueMetalico = GetWorld()->SpawnActor<ABloqueMetalico>(ABloqueMetalico::StaticClass());
        PiezaDirector->SetConstruirPieza(BloqueMetalico);
        GEngine->AddOnScreenDebugMessage(-1, 4, FColor::Yellow, TEXT("Pieza Metalica"));
        break;
    case 2:
        BloquePiedra = GetWorld()->SpawnActor<ABloquePiedra>(ABloquePiedra::StaticClass());
        PiezaDirector->SetConstruirPieza(BloquePiedra);
        GEngine->AddOnScreenDebugMessage(-1, 4, FColor::Yellow, TEXT("Pieza Piedra"));
        break;
    case 3:
        BloqueDorado = GetWorld()->SpawnActor<ABloqueDorado>(ABloqueDorado::StaticClass());
        PiezaDirector->SetConstruirPieza(BloqueDorado);
        GEngine->AddOnScreenDebugMessage(-1, 4, FColor::Yellow, TEXT("Pieza Dorada"));
        break;
    case 4:
        BloqueHielo = GetWorld()->SpawnActor<ABloqueHielo>(ABloqueHielo::StaticClass());
        PiezaDirector->SetConstruirPieza(BloqueHielo);
        GEngine->AddOnScreenDebugMessage(-1, 4, FColor::Yellow, TEXT("Pieza Hielo"));
        break;
    case 5:
        BloqueMulticolor = GetWorld()->SpawnActor<ABloqueMulticolor>(ABloqueMulticolor::StaticClass());
        PiezaDirector->SetConstruirPieza(BloqueMulticolor);
